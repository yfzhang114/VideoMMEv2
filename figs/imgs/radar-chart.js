document.addEventListener("DOMContentLoaded", function () {
  ...
  // Ordered by Non-Lin score descending:
  // Human Expert (90.6) > Gemini-3-Pro (49.4) > Doubao-Seed (43.2) > Qwen3.5-397B (39.1) > GPT-5 (36.9) > Qwen3-VL-235B (25.0) > InternVL3-5-241B (23.1) > Qwen3-Omni-30B (17.1)
  const orderedModels = [
    "Human Expert",
    "Gemini-3-Pro",
  ...
  const colors = {
    "Human Expert": "#8E9EAB",
    "Gemini-3-Pro": "#7C9885",
    "Doubao-Seed-2.0-Pro-260215": "#D07C74",
    "Qwen3.5-397B-A17B-Think": "#B59E75",
    "GPT-5": "#D9A05B",
    "Qwen3-VL-235B-A22B-Instruct": "#C48E97",
    "InternVL3-5-241B-A28B-Instruct": "#6CA1A2",
  ...
  let userLegendState = {
    "Human Expert": true,
    "Gemini-3-Pro": true,
    "Doubao-Seed-2.0-Pro-260215": false,
    "Qwen3.5-397B-A17B-Think": true,
    "GPT-5": true,
    "Qwen3-VL-235B-A22B-Instruct": false,
    "InternVL3-5-241B-A28B-Instruct": false,
